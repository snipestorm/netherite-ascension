...
public class ObsidianAlterBlockEntityRenderer implements BlockEntityRenderer<ObsidianAltarBlockEntity, AltarBlockEntityRenderState> {
    private final ItemModelResolver itemModelResolver;

    public ObsidianAlterBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
    ...
    @Override
    public void extractRenderState(ObsidianAltarBlockEntity blockEntity, AltarBlockEntityRenderState state, float partialTicks, Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress) {
