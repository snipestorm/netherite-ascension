...
public class AltarStarThrownOverworldSubAchievementTrigger extends SimpleCriterionTrigger<AltarStarThrownOverworldSubAchievementTrigger.Instance> {

    public static final Identifier ID =
            Identifier.fromNamespaceAndPath(NetheriteAscension.MOD_ID, "altar_star_overworld_trigger");

    public static final AltarStarThrownOverworldSubAchievementTrigger INSTANCE = new AltarStarThrownOverworldSubAchievementTrigger();
